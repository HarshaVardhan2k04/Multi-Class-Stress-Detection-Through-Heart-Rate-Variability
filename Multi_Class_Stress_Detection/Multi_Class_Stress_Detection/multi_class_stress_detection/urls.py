...
urlpatterns = [
    ...
    url(r'^Predict_Stress_Detection/$', remoteuser.Predict_Stress_Detection, name="Predict_Stress_Detection"),
    ...
    url(r'^View_Predict_Stress_Detection_Type_Ratio/$', serviceprovider.View_Predict_Stress_Detection_Type_Ratio, name="View_Predict_Stress_Detection_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Predict_Stress_Detection_Details/$', serviceprovider.View_Predict_Stress_Detection_Details, name="View_Predict_Stress_Detection_Details"),
